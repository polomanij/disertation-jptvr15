        ...
        <section class="data">
          ...
          <div class="data-common">
            <div class="data-common-item">
              <p class="data-common-title">Credit: <span class="data-common-val workspace-credit">${credit} EUR</span></p>
            </div>
            <div class="data-common-item">
              <p class="data-common-title">Last expense: <span class="data-common-val workspace-last-expense">${lastExpense}</span></p>
            </div>
            <div class="data-common-item">
              <p class="data-common-title">Last income: <span class="data-common-val workspace-last-income">${lastIncome}</span></p>
            </div>
          </div>
          <h2>Add Income</h2>
          ...
          <div class="data-adding">
            <div class="data-adding-item">
              <select class="category-select expense-adding-select">
